...
for num, fold in enumerate(folds, 1):
    ...
    test_fold = fold
    # on récolte les indices qui ne font pas parti du fold de test
    train_idx = []
    for f in folds:
        if f != test_fold:
            for indice in f:
    ...
    # pas de sampling aléatoire car toutes les images sans transformation y passe
