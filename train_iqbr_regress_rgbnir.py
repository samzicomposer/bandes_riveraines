...
from utils.valid_dataset_rgbnir import ValidDataset, TestDataset
...
for epoch in range(epochs):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        #   mean = np.array(means_t[0:3])  # nécessaire pour inverser la normalisation
        #   std = np.array(stds_t[0:3])  # nécessaire pour inverser la normalisation
